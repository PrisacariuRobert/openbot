...
- Schedules and Calendar polling run only while the local OpenBot service and Mac are awake. Missed work can be noticed when the service returns, but 0.15 does not provide a hosted lease or guaranteed offline catch-up.
