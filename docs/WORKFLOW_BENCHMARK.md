...
| Proactive connected work | Pass for focused personal sources | Calendar, Todoist activity, Dropbox deltas, signed GitHub hooks, and signed generic hooks can start bounded work with dedupe, cursors, receipts, and approval-safe tools | OpenBot is inspectable and owner-controlled; Grok remains broader across hosted event sources |
| Large plugin catalog | Partial in 0.27 | Gmail, Drive, Calendar, GitHub, Slack, Notion, Todoist, and Dropbox are real bounded connectors; portable browser skills are data-only and there is no third-party executable marketplace yet | Grok remains broader |
