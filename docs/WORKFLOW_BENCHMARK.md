...
| Large plugin catalog | Partial in 0.17 | Gmail, Drive, Calendar, GitHub, Slack, and Notion are real bounded connectors; there is no third-party marketplace yet | Grok remains broader |
| Always-on hosted cloud computer | Not in 0.17 | Computers are persistent while the local host/Docker are available | Different privacy/availability tradeoff |
