...
if (!project.includes("MARKETING_VERSION: 0.18.0")) throw new Error("The iOS marketing version is not 0.18.0.");
if (!project.includes("CURRENT_PROJECT_VERSION: 22")) throw new Error("The iOS build number is not 22.");
