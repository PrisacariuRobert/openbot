...
if (!project.includes("MARKETING_VERSION: 0.17.3")) throw new Error("The iOS marketing version is not 0.17.3.");
if (!project.includes("CURRENT_PROJECT_VERSION: 20")) throw new Error("The iOS build number is not 20.");
...
console.log("Native SwiftUI studio, privacy declarations, Keychain storage, API streaming, draft continuity, asynchronous mascot motion, and UI coverage are present.");
