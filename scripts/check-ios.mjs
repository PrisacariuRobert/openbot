...
if (!project.includes("MARKETING_VERSION: 0.22.0")) throw new Error("The iOS marketing version is not 0.22.0.");
if (!project.includes("CURRENT_PROJECT_VERSION: 26")) throw new Error("The iOS build number is not 26.");
...
console.log("Native SwiftUI studio, APNs registration, share-sheet ingestion, privacy declarations, Keychain storage, API streaming, draft continuity, Live Studio, customizable code-drawn mascot motion, and UI coverage are present.");
