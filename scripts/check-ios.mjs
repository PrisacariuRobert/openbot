...
if (!project.includes("MARKETING_VERSION: 0.17.4")) throw new Error("The iOS marketing version is not 0.17.4.");
if (!project.includes("CURRENT_PROJECT_VERSION: 21")) throw new Error("The iOS build number is not 21.");
...
console.log("Native SwiftUI studio, privacy declarations, Keychain storage, API streaming, draft continuity, customizable code-drawn mascot motion, and UI coverage are present.");
