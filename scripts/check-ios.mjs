...
if (!project.includes("MARKETING_VERSION: 0.21.0")) throw new Error("The iOS marketing version is not 0.21.0.");
if (!project.includes("CURRENT_PROJECT_VERSION: 25")) throw new Error("The iOS build number is not 25.");
