...
if (!project.includes("MARKETING_VERSION: 0.17.2")) throw new Error("The iOS marketing version is not 0.17.2.");
if (!project.includes("CURRENT_PROJECT_VERSION: 19")) throw new Error("The iOS build number is not 19.");
...
console.log("Native SwiftUI studio, privacy declarations, Keychain storage, API streaming, draft continuity, and UI coverage are present.");
