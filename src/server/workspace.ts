...
`;
  ...
  writeFileSync(path.join(toolsDir, "code_request_review.ts"), toolFile("code_request_review", "Ask a different teammate to independently review the exact tested commit before publishing.", `projectId: tool.schema.string(), reviewerBotId: tool.schema.string()`, "code_request_review"), "utf8");
