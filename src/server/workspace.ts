...
export function prepareWorkspace(db: OpenBotDatabase, bot: Bot, reportOnly = false) {
  ...
  const operatingRules = ([
    ...
    [on("browser_open"), "- Use the browser tools for websites. If a cookie banner blocks the page, choose Reject all / Do not consent / Necessary only (no approval needed); never accept all cookies."],
