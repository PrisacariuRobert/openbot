...
test("keeps irrelevant app schemas out of a file-only task and updates after capability changes", () => {
  ...
  try {
    ...
    for (const name of ["task_plan", "task_progress", "task_verify", "routine_create", "routine_list", "routine_update", "routine_pause", "routine_resume", "remember", "handoff", "message_teammate"]) {
