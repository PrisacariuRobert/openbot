...
function friendlyToolActivity(rawName: string, title: string | null): ToolActivity {
  ...
  const labels: Record<string, string> = {
    ...
    code_branch: "Starting a safe work branch", code_commit: "Saving a reviewed checkpoint", code_publish_pr: "Preparing a pull request for your approval", code_run: "Running project checks",
