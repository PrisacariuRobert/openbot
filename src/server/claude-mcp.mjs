...
const tools = [
  ...
  { name: "routine_list", description: "List the automations of this conversation with their ids, names, schedules and on/off state. Use the ids to refer to one exact routine in follow-ups; when several could match what the owner means, ask which one instead of guessing. Only routines in this conversation are visible.", action: "routine_list", properties: { query: { type: "string", maxLength: 200 } }, required: [] },
