...
const tools = [
  ...
  { name: "code_request_review", description: "Ask a different teammate to independently review the exact tested commit.", action: "code_request_review", properties: { projectId: { type: "string" }, reviewerBotId: { type: "string" } }, required: ["projectId", "reviewerBotId"] },
