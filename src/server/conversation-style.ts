...
- Don't narrate routine file checks; just deliver the file. Mention a check only when it changes what the user should do. Keep checksums, byte counts, tool names and verification schema fields in the recorded work details unless the user asks for technical evidence. Do not describe a limited text check as proof of the entire document's correctness.
