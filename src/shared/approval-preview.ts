...
export function approvalPreview(
  ...
  if (
  ...
  } else if (object.type === "routine_resume" || object.type === "routine_update") {
    // P03b: exact routine review. The id, bound revision and change summary
    ...
    if (!routineId || !routineName || boundRevision === null || !changeSummary.trim()) incomplete = true;
      ...
      preview.fields.push(
        ...
        { label: object.type === "routine_resume" ? "Resume" : "Change", value: visible(changeSummary) },
        { label: "Effect", value: "Only this routine changes; nothing else is enabled, broadened or deleted. If the routine changed since this review, approval fails and asks for a fresh proposal." },
      );
  ...
  if (supported && object.type !== "task_tokens" && object.type !== "run" && object.type !== "mac_organize" && object.type !== "routine_resume" && object.type !== "routine_update" && object.type !== "browser_sign_in" && object.type !== "browser_click" && object.type !== "browser_type" && object.type !== "browser_upload_saved_file" && object.type !== "self_extend" && object.type !== "skill_propose") {
