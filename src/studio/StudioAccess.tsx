...
export function StudioAccess({ children }: { children: ReactNode }) {
  ...
  return <main className="studio-access"><section>
    ...
    <p>{phase === "locked" ? "On your Mac, open Settings → Your phone and scan the code with this phone’s camera. Or use your studio’s access key." : phase === "offline" ? "Keep the Mac running OpenBot awake and connected. We’ll reconnect automatically when it’s available." : "Your conversations and teammates will be here in a moment."}</p>
